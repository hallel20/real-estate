    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            <div className="flex flex-col items-center">
              <div className="w-24 h-24 rounded-full overflow-hidden mb-4">
                <img
                  src={user?.profileImage || 'https://images.pexels.com/photos/1043471/pexels-photo-1043471.jpeg'}
                  alt={user?.username}
            ...
            <nav>
              <button
                ...
                className={`flex items-center w-full px-6 py-3 text-left ${
                  activeTab === 'properties' ? 'bg-blue-50 text-blue-600 border-l-4 border-blue-600' : 'text-gray-700 hover:bg-gray-50'
                }`}
              >
              ...
              <button
                ...
                className={`flex items-center w-full px-6 py-3 text-left ${
                  activeTab === 'inquiries' ? 'bg-blue-50 text-blue-600 border-l-4 border-blue-600' : 'text-gray-700 hover:bg-gray-50'
                }`}
              >
        ...
        <div className="lg:col-span-3">
                        ...
                        <div className="md:w-3/4 p-6">
                          ...
                          <div className="flex flex-wrap gap-4">
                            ...
                            <Button 
                              ...
                              onClick={() => usePropertyStore.getState().toggleFavorite(property.id)}
                            >
          ...
          {activeTab === 'inquiries' && (
            <div>
              <h2 className="text-2xl font-semibold text-gray-900 mb-6">My Inquiries</h2>
